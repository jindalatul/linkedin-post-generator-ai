<?php
/*
http://localhost/sharing/api/call.php?topic=5 digital marketing trends 2024&tone=professional&hashtag=yes&emoji=yes
*/
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container">
  ...
  <div class="row">
            ...
            <div id="linkedIn-prompt-form">
                <div class="form-group">
                    <input class="form-control input-lg" 
                            Placeholder="Describe post or paste url of topic" 
                            id="topic" 
                            name="topic"
                            type="text">
                </div>
                ...
                <div class="checkbox">
                    <label><input type="checkbox" name="hastags" id="hashtags">Include HashTags</label>
                    <label><input type="checkbox" name="emoji" id="emoji">Include Emoji</label>
                </div>
                <button type="button" class="btn" 
                        id="generate-posts-btn">Generate Post</button>
            </div>
            <br>
            <div id="post-text-editor" style="display: none;">
                <div style="display:block; height:24px;margin-top:10px;margin-bottom:30px;padding-top:5px;padding-bottom:10px;">
                    <div class="my-options">
                        <?php //<a href="#" id="more-expand-post">Expand</a> //?>
                        <a href="javascript:void(0);" id="Generate-Prompt-Again">Generate Prompt Again</a> | <a href="javascript:void(0);" id="post-preview-btn">Preview</a>
                    </div>
                </div>
    ...
    <div class="col-sm-6" id="post-preview" style="display: none; margin-top: 82px;">
        <div class="row">
            <div class="col-sm-12" style="border:solid 1px #e5e7eb;">
                ...
                <div class="btn-group" style="float:right; padding-bottom: 1rem;">
                  ...
                  */?>
                <a style="float:right;" href="javascript:void(0);" id="copy-post">Copy</a>
            </h3>
                    ...
                    <div class="font-system custom-box">
                            ...
                            padding-bottom: 1.25rem;">
                                <div class="profile-section">
                                        <div>
                                                <img class="linkedin-profile-pic" src="./media/profile-pic.svg" />
                                        </div>
                                    ...
                                    <div id="social-linkedin-post-content" class="overflow-hidden"></div>
                                    <div class="padding-reactions">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center justify-start gap-2">
                                                <img alt="post reactions"  width="24" height="24"  class="h-5 w-auto" style="color:transparent" src="./media/post-reactions.svg">
